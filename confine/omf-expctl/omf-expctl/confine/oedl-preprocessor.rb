		...
		# The CONFINE sliceId (~ OMF testbed name)
            ...
            @nodes.each do |node|
                ...
                # Also not looking at the "imageID".
                 g = confine.allocateSliverGroup( :sliceid => sliceId, 
                                             :names => node.nodeID,
                                             :nwifi => 2.to_s,
                                             :neth => 2.to_s,
                                             :imageid => '0'
